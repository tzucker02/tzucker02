...
I have started to develop a new repo dedicated to creating and using virtual environments. I have only just started out on it, but if you are interested feel free to visit it [here](https://github.com/tzucker02/Virtual_environment/blob/main/README.md).
