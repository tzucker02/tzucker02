...
As a new item I have started to develop a repo dedicated to creating virtual environments. I have only just started out on it, but if you are interested feel free to visit it [here](https://github.com/tzucker02/Virtual_environment/blob/main/README.md).
